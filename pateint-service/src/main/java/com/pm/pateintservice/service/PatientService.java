...
import com.pm.pateintservice.kafka.KafkaProducer;
...
//    Create Patients
    public PatientResponseDTO createPatient(PatientRequestDTO patientRequestDTO) {
        ...
        log.info("Billing response received: {}", billingResponse);

        kafkaProducer.sendEvent(newPatient);  // kafka producer that produce event and send
